      ...
      <tbody>
        ...
        <select name="estaciones">
          ...
          <tr>
            ...
            <td>
              <select name="sistemadecarga">
                <option value="consistema">Sistema funcionando</option>
                <option value="sinsistema">Sin sistema</option>
              </select>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <br>
            <hr>
            <a href="consulta.php" class="btn btn-warning">Mis auditorias</a><br>
            <hr>
            <a href="reporteGeneral.php" class="btn btn-warning">Auditorias generales</a><br>
            </td>
          </tr><br>
          <?php
